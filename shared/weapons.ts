...
export const MAP_PICKUPS: MapPickupSpec[] = [
  { id: 'w_ak_l', kind: 'weapon', item: 'ak', x: 500, y: 364 },
  { id: 'w_m4_h', kind: 'weapon', item: 'm4', x: 1720, y: 600 },
  { id: 'w_spas_l', kind: 'weapon', item: 'spas', x: 840, y: 600 },
  { id: 'w_m79_m', kind: 'weapon', item: 'm79', x: 1380, y: 497 },
  { id: 'w_flamer_m', kind: 'weapon', item: 'flamer', x: 1540, y: 761 },
  { id: 'w_law_sky', kind: 'weapon', item: 'law', x: 1280, y: 137 },
  { id: 'w_minigun_r', kind: 'weapon', item: 'minigun', x: 2060, y: 364 },
  { id: 'w_barrett_r', kind: 'weapon', item: 'barrett', x: 1860, y: 500 },
  ...
  { id: 'med_l', kind: 'medkit', item: '', x: 680, y: 486 },
  { id: 'med_r', kind: 'medkit', item: '', x: 1880, y: 486 },
  ...
  { id: 'nade_cluster', kind: 'nade', item: 'cluster', x: 1120, y: 697 },
  { id: 'nade_sting', kind: 'nade', item: 'sting', x: 1440, y: 697 },
  ...
  { id: 'bon_berserk', kind: 'bonus', item: 'berserk', x: 640, y: 458 },
  { id: 'bon_pred', kind: 'bonus', item: 'predator', x: 1480, y: 257 },
  { id: 'bon_flame', kind: 'bonus', item: 'flamegod', x: 1920, y: 458 },
];
