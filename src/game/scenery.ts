...
export const SCENERY: ScenerySpec[] = [
  ...
  { x: 150, y: 400, key: 'prop_barrel', scale: 0.22, depth: 0 },
  ...
  { x: 1240, y: 760, key: 'prop_barrel', scale: 0.2, depth: 0 },
